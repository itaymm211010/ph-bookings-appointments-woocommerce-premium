 ...
 * Booking Reminder
 *
 * An email sent to the user to remind them about the booking prior to the booking start date.
 *
 * @class   Ph_WC_Email_Booking_reminder
 * @extends WC_Email
 */
class Ph_WC_Email_Booking_reminder extends WC_Email
{
	/**
	 * @var $blog_name
	 */
	...
	{
		$this->id   = 'ph_booking_reminder';
		$this->template_base = PH_BOOKINGS_TEMPLATE_PATH;
		$this->customer_email = true;
		$this->template_html  = 'emails/ph-customer-booking-reminder.php';
		$this->template_plain = 'emails/ph-customer-booking-reminder-plain.php';
		$this->title          = __('PH Bookings Reminder', 'bookings-and-appointments-for-woocommerce');
		$this->description    = __('Bookings reminder emails are sent prior to the booking start date & time.', 'bookings-and-appointments-for-woocommerce');
	...
	public function get_default_subject()
	{
		...
		return __("Bookings Reminder", 'bookings-and-appointments-for-woocommerce');
	}
	...
	public function get_default_additional_content()
	{
		...
		return __('We look forward to serving you.<br>Regards<br>Admin', 'bookings-and-appointments-for-woocommerce');
	}
	...
	public function init_form_fields()
	{
		...
		$this->form_fields = array(
			...
			'reminder_time' => array(
				'title'       => __('Reminder Time', 'bookings-and-appointments-for-woocommerce'),
				'type'        => 'number',
				'description' => __('Enter how many minutes in advance the reminder email should be sent.', 'bookings-and-appointments-for-woocommerce'),
				'placeholder' => '60',
				'default'     => '60',
				'desc_tip'      => true,
			),
...
new Ph_WC_Email_Booking_reminder();
