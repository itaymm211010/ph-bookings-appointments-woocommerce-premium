...
class phive_booking_admin_pages {
	...
	public function ph_booking_admin_menu(){	
		...
		add_submenu_page(
			"bookings",
			"Add Product",
			__("Add Product",'bookings-and-appointments-for-woocommerce'),
			"manage_woocommerce",
			"add_product", 
			array( $this, "ph_add_booking_product" )
		);
	...
	function ph_add_booking_product() {
	...
	function ph_booking_settings_page(){
		...
		<div class="wrap woocommerce">
			...
			<h2 class="nav-tab-wrapper ph-setting-tabs">
				<a href="?page=bookings-settings&tab=licence" class="nav-tab <?php if($active_tab == 'licence'){echo 'nav-tab-active';} ?>"><?php _e('Plugin Licence', 'bookings-and-appointments-for-woocommerce'); ?></a>
	...
	private function ph_booking_settings_licence(){
		?>
		<div class='wrap'>
			<h2><?php _e('Plugin Licence Activation','bookings-and-appointments-for-woocommerce')?></h2>
			</p>
			<?php
