		...
		<table class="form-table">
			<tbody>
				...
				<tr class="ph-add-booking-page-send-email-tr">
					...
					<td><input type="checkbox" id="ph_add_booking_send_payment_email" name="send_payment_email" value="1"><label><?php _e('Send payment link email to customer.','bookings-and-appointments-for-woocommerce' ); ?></label></td>
				</tr>
				<?php if($_POST['ph_customer_id'] == '0'){ ?>
					<tr class="ph_guest_email_id_panel">
					<th class="ph-add-booking-page-th-hide"></th>
						<td>
							<label for="ph_guest_email_id"><?php _e('Please enter Email id:') ?></label>
