...
<form method="post" action="" id="">
	...
	<ul style="list-style-type: disc;padding-left:1.3em">
		<li>
			<?php _e('Read more to know how to set up ','bookings-and-appointments-for-woocommerce');?><a href="https://www.pluginhive.com/knowledge-base/sync-woocommerce-bookings-with-your-google-calendar"  target="_blank"><?php _e('Google Calendar Sync','bookings-and-appointments-for-woocommerce')?></a>.
		</li>
		<li>
			<?php _e('Read more to know how to ','bookings-and-appointments-for-woocommerce');?><a href="https://www.pluginhive.com/knowledge-base/troubleshooting-google-calendar-sync-woocommerce-bookings-and-appointments-plugin/"  target="_blank"><?php _e('Troubleshoot Google Calendar Sync','bookings-and-appointments-for-woocommerce')?></a>.
		</li>
		<li>
			<?php _e('Read more to know the ','bookings-and-appointments-for-woocommerce');?><a href="https://www.pluginhive.com/knowledge-base/woocommerce-bookings-and-appointments-plugin-faqs/#GoogleSync"  target="_blank"><?php _e('Frequently asked questions about Google Calendar Sync','bookings-and-appointments-for-woocommerce')?></a>.
		</li>
	</ul>
