<tr class="rule ui-sortable-handle">
	...
	<td>
		<div class="availability_by_date" style="display: <?php echo ( isset($rule['availability_type'] ) && $rule['availability_type']=='custom' ) || empty($rule['availability_type']) ? 'block;' : 'none;';?>">
			<input type="text" class="availability_date_picker ph_booking_asset_from_date" autocomplete="off" name="ph_booking_asset_from_date[]" value="<?php echo isset($rule['from_date']) ? $rule['from_date'] : '';?>" style="width: 100px;" >
		</div>
	...
	<td>
		<div class="availability_by_date" style="display: <?php echo ( isset($rule['availability_type'] ) && $rule['availability_type']=='custom' ) || empty($rule['availability_type']) ? 'block;' : 'none;';?>">
			<input type="text" class="availability_date_picker ph_booking_asset_to_date" autocomplete="off" name="ph_booking_asset_to_date[]" value="<?php echo isset($rule['to_date']) ? $rule['to_date'] : '';?>" style="width: 100px;" >
		</div>
