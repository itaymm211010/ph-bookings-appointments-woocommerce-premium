...
<p>
	<?php
		echo __( 'Hii', 'bookings-and-appointments-for-woocommerce' ).' '.$customer_full_name.',<br><br>';
		echo __( 'Thanks for placing your booking.', 'bookings-and-appointments-for-woocommerce' ).'<br><br>';
		printf( __( 'We request you to go through the booking details attached in this email', 'bookings-and-appointments-for-woocommerce' ) );
