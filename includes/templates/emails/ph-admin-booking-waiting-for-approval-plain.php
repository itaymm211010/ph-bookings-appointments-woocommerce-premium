...
echo __("New customer order\n", 'bookings-and-appointments-for-woocommerce');
echo sprintf(__("\nYou have received an order #%s. The order is waiting for approval. The order is as follows", 'bookings-and-appointments-for-woocommerce'), $order->get_id());
