...
/**
 * PH Admin booking cancelled email Plain.
 * 
...
echo sprintf(__("\nYour booking at %s has been marked as %s.\n", 'bookings-and-appointments-for-woocommerce'), $email->blog_name, __($email->booking_status, 'bookings-and-appointments-for-woocommerce'));
