...
/**
 * PH Customer booking reminder email HTML.
 * 
...
<p>
    ...
    printf(__('I request you to check the bookings details for your appointment with %s.', 'bookings-and-appointments-for-woocommerce'), $email->blog_name);
    ?>
</p>
